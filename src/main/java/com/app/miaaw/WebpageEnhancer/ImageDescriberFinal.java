...
public class ImageDescriberFinal {			
	
	public static List<String> getDescription() throws IOException {
		...
		Document link = SoupChef.makeLinkSoup("https://www.amazon.de/ref=nav_logo");
		String s = "";
